...
const productComponents: {
  ...
  },
  {
    ...
    description: "Create and add a new product to the system.",
  },
];
  ...
  return (
    <NavigationMenu className="hidden md:flex">
      <NavigationMenuList>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger>Loan Offers</NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
              {loanOfferComponents.map((component) => (
                <ListItem
                  key={component.title}
                  title={component.title}
                  href={component.href}
